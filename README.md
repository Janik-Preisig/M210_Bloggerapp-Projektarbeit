...
Der Storage-Bucket und die Policies für `storage.objects` werden durch das Schema erzeugt. Um ein Konto zum Admin zu machen, nach dessen Registrierung einmalig im SQL Editor ausführen:
